...
<dict>
    ...
    color_string(colors.bg2), -- DVTConsoleTextSelectionColor
    color_string(colors.yellow), -- DVTDebuggerInstructionPointerColor
    -- Markup colors
    color_string(colors.bg0), -- DVTMarkupTextBackgroundColor
    color_string(colors.bg2), -- DVTMarkupTextBorderColor
    ...
    color_string(colors.fg1, 0.7), -- DVTMarkupTextInlineCodeColor
    ...
    color_string(colors.orange), -- DVTScrollbarMarkerDiffColor
    color_string(colors.red), -- DVTScrollbarMarkerDiffConflictColor
    color_string(colors.crimson), -- DVTScrollbarMarkerErrorColor
    color_string(colors.magenta), -- DVTScrollbarMarkerRuntimeIssueColor
    color_string(colors.amber), -- DVTScrollbarMarkerWarningColor
    -- Source editor colors
    color_string(colors.bg), -- DVTSourceTextBackground
    color_string(colors.bg0), -- DVTSourceTextBlockDimBackgroundColor
    color_string(colors.bg3), -- DVTSourceTextCurrentLineHighlightColor
    color_string(colors.fg), -- DVTSourceTextInsertionPointColor
    color_string(colors.fg3), -- DVTSourceTextInvisiblesColor
    color_string(colors.bg2), -- DVTSourceTextSelectionColor
    -- Syntax colors
    color_string(colors.blue), -- xcode.syntax.attribute
    ...
    color_string(colors.crimson), -- xcode.syntax.identifier.function
    color_string(colors.blue), -- xcode.syntax.identifier.function.system
    ...
    color_string(colors.blue), -- xcode.syntax.identifier.variable.system
    color_string(colors.green), -- xcode.syntax.keyword
    color_string(colors.purple), -- xcode.syntax.mark
    color_string(colors.orange), -- xcode.syntax.markup.code
    color_string(colors.gold), -- xcode.syntax.number
    color_string(colors.fg), -- xcode.syntax.plain
    color_string(colors.red), -- xcode.syntax.preprocessor
    color_string(colors.fg1), -- xcode.syntax.string
    color_string(colors.blue), -- xcode.syntax.url
