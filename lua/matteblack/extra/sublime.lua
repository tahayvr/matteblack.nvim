...
function M.generate(colors)
  colors.error_bg = util.blend_bg(colors.crimson, 0.1)
  colors.warning_bg = util.blend_bg(colors.amber, 0.1)
  colors.info_bg = util.blend_bg(colors.gold, 0.1)
...
<dict>
	<key>author</key>
	<string>Taha Yavari (http://github.com/tahayvr)</string>
	<key>colorSpaceName</key>
	<string>sRGB</string>
	<key>name</key>
	<string>Matte Black</string>
	<key>semanticClass</key>
	<string>theme.matteblack</string>
	<key>settings</key>
	<array>
		<dict>
			<key>settings</key>
			<dict>
				...
				<string>${fg}</string>
				<key>guide</key>
				<string>${bg2}40</string>
				<key>gutterForeground</key>
				<string>${bg2}aa</string>
				<key>inactiveSelection</key>
				<string>${bg3}</string>
				<key>invisibles</key>
				<string>${bg2}</string>
				<key>lineHighlight</key>
				<string>${bg3}30</string>
				<key>selection</key>
				<string>${bg2}40</string>
				<key>selectionBorder</key>
				<string>${orange}</string>
				<key>shadow</key>
				<string>${bg0}10</string>
				<key>stackGuide</key>
				<string>${bg2}60</string>
				<key>tagsOptions</key>
	...
	<key>uuid</key>
	<string>matteblack-sublime-theme</string>
</dict>
</plist>
